...
func TestPrint(t *testing.T) {
	...
	cases := []PrintTestCase{
		...
		},
		{
			...
			ExpectedRows: []string{
				message,
				wd+"/error_helper_test.go:17 github.com/mikroskeem/tracerr_test.addFrameC()",
				wd+"/error_helper_test.go:13 github.com/mikroskeem/tracerr_test.addFrameB()",
				wd+"/error_helper_test.go:9 github.com/mikroskeem/tracerr_test.addFrameA()",
				wd+"/print_test.go:26 github.com/mikroskeem/tracerr_test.TestPrint()",
			},
		...
		},
		{
			...
			ExpectedRows: []string{
				message,
				"",
				aurora.Bold(wd+"/error_helper_test.go:17 github.com/mikroskeem/tracerr_test.addFrameC()").String(),
				...
				"",
				aurora.Bold(wd+"/error_helper_test.go:13 github.com/mikroskeem/tracerr_test.addFrameB()").String(),
				...
				"",
				aurora.Bold(wd+"/error_helper_test.go:9 github.com/mikroskeem/tracerr_test.addFrameA()").String(),
				...
				"",
				aurora.Bold(wd+"/print_test.go:26 github.com/mikroskeem/tracerr_test.TestPrint()").String(),
